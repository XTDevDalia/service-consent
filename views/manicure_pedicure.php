...
<form action="" method="post" >
    ...
    <div class="row">
        <div class="col-sm-10">
            ...
            <div class="col-sm-4">
                <input type="text" id="client_signature" class="form-control" name="client_signature">
            </div>
            <div class="col-sm-1">
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-sm-10">
            ...
            <div class="col-sm-4">
                <input type="text" id="therapist_signature" class="form-control" name="therapist_signature">
            </div>
            <div class="col-sm-1">
                <label style="text-align: right;">Date</label>
            </div>
            <div class="col-sm-2">
                <input type="date" id="therapist_date" class="form-control" for="therapist_date">
            </div>
            <div class="col-sm-1">
            </div>
        </div>
